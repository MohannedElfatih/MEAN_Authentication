    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this._authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this._flashMessagesService.show('You\'re now logged in.', { cssClass: 'alert-success', timeout: 3000 });
                _this._router.navigate(['profile']);
            }
            else {
                _this._flashMessagesService.show(data.msg, { cssClass: 'alert-danger', timeout: 4500 });
...
var ProfileComponent = (function () {
    function ProfileComponent(_authService, _router, _flashMessagesService) {
        this._authService = _authService;
        this._router = _router;
        this._flashMessagesService = _flashMessagesService;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_flash_messages__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_flash_messages___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_angular2_flash_messages__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_validate_service__ = __webpack_require__(69);
...
var RegisterComponent = (function () {
    function RegisterComponent(_validateService, _flashMessagesService, _authService, _router) {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this._validateService.validateRegister(user)) {
            ...
            this._authService.registerUser(user).subscribe(function (data) {
                if (data.success) {
                    _this._flashMessagesService.show('You\'re now registered.', { cssClass: 'alert-success', timeout: 3000 });
                    _this._router.navigate(['/login']);
                }
                else {
...
var AuthService = (function () {
    ...
    AuthService.prototype.loggedIn = function () {
        console.log(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_angular2_jwt__["tokenNotExpired"])());
...
module.exports = "<h2 class=\"page-header\">Dashboard</h2>\r\n<p>Welcome to your dashboard {{_authService.user.name}}</p>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_register_register_component__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_home_home_component__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_dashboard_dashboard_component__ = __webpack_require__(100);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__services_auth_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__ = __webpack_require__(106);
